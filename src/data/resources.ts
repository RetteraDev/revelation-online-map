...
export const items: Record<EItem, IItem> = {
    // ECategory.MINING
    [EItem.LIMESTONE]: { itemName: 'Известняк', icon: '', category: ECategory.MINING },
    [EItem.PEBBLE]: { itemName: 'Галька', icon: '', category: ECategory.MINING },
    [EItem.SILVER_ORE]: { itemName: 'Серебряная руда', icon: '', category: ECategory.MINING },
    [EItem.COPPER_ORE]: { itemName: 'Медная руда', icon: '', category: ECategory.MINING },
    [EItem.SANDSTONE]: { itemName: 'Песчаник', icon: '', category: ECategory.MINING },
    [EItem.GOLD_ORE]: { itemName: 'Золотая руда', icon: '', category: ECategory.MINING },
    [EItem.IRON_ORE]: { itemName: 'Железная руда', icon: '', category: ECategory.MINING },
    [EItem.SPINEL]: { itemName: 'Шпинель', icon: '', category: ECategory.MINING },
    [EItem.SLATE]: { itemName: 'Сланец', icon: '', category: ECategory.MINING },
    [EItem.BAUXITE]: { itemName: 'Боксит', icon: '', category: ECategory.MINING },
    [EItem.LIMONITE]: { itemName: 'Лимонит', icon: '', category: ECategory.MINING },
    [EItem.AMETRINE]: { itemName: 'Аметрин', icon: '', category: ECategory.MINING },
    [EItem.GRANITE]: { itemName: 'Гранит', icon: '', category: ECategory.MINING },
    [EItem.JADE]: { itemName: 'Нефрит', icon: '', category: ECategory.MINING },
    [EItem.RHYOLITE_CHIP]: { itemName: 'Риолитовая крошка', icon: '', category: ECategory.MINING },
    [EItem.MARBLE]: { itemName: 'Мрамор', icon: '', category: ECategory.MINING },
    [EItem.CORUNDUM]: { itemName: 'Корунд', icon: '', category: ECategory.MINING }, 

    // ECategory.HERBALISM
    [EItem.MEADOW_COLLECTION]: { itemName: 'Луговой сбор', icon: '', category: ECategory.HERBALISM },
    [EItem.CHAMPIGNON]: { itemName: 'Шампиньон', icon: '', category: ECategory.HERBALISM },
    [EItem.ROSEHIP]: { itemName: 'Шиповник', icon: '', category: ECategory.HERBALISM },
    [EItem.SWAMP_COLLECTION]: { itemName: 'Болотный сбор', icon: '', category: ECategory.HERBALISM },
    [EItem.FERN_LEAVES]: { itemName: 'Листья папоротника', icon: '', category: ECategory.HERBALISM },
    [EItem.GINSENG_ROOT]: { itemName: 'Корень женьшеня', icon: '', category: ECategory.HERBALISM },
    [EItem.NASTURTIUM_BLOSSOM]: { itemName: 'Цветок настурции', icon: '', category: ECategory.HERBALISM },
    [EItem.RATTAN_STEMS]: { itemName: 'Стебли ротанга', icon: '', category: ECategory.HERBALISM },
    [EItem.FIELD_COLLECTION]: { itemName: 'Полевой сбор', icon: '', category: ECategory.HERBALISM },
    [EItem.CORIANDER]: { itemName: 'Кориандр', icon: '', category: ECategory.HERBALISM },
    [EItem.ALMOND_FLOWERS]: { itemName: 'Цветы миндаля', icon: '', category: ECategory.HERBALISM },
    [EItem.FOREST_COLLECTION]: { itemName: 'Лесной сбор', icon: '', category: ECategory.HERBALISM },
    [EItem.RED_FROG]: { itemName: 'Красная лягушка', icon: '', category: ECategory.HERBALISM },
    [EItem.CENTIPEDE]: { itemName: 'Многоножка', icon: '', category: ECategory.HERBALISM },
    [EItem.GARDEN_COLLECTION]: { itemName: 'Садовый сбор', icon: '', category: ECategory.HERBALISM },
    [EItem.SILKWORM_PUPA]: { itemName: 'Куколка шелкопряда', icon: '', category: ECategory.HERBALISM },

    // ECategory.WOODCRAFTING
    [EItem.ROTTEN_WOOD]: { itemName: 'Гнилая древесина', icon: '', category: ECategory.WOODCRAFTING },
    [EItem.BAMBOO_SHOOTS]: { itemName: 'Побеги бамбука', icon: '', category: ECategory.WOODCRAFTING },
    [EItem.BAMBOO_STALKS]: { itemName: 'Стебли бамбука', icon: '', category: ECategory.WOODCRAFTING },
    [EItem.ORDINARY_WOOD]: { itemName: 'Обычная древесина', icon: '', category: ECategory.WOODCRAFTING },
    [EItem.PEACH_BLOSSOMS]: { itemName: 'Цветы персика', icon: '', category: ECategory.WOODCRAFTING },
    [EItem.TERMITE]: { itemName: 'Термит', icon: '', category: ECategory.WOODCRAFTING },
    [EItem.SANDAL]: { itemName: 'Сандал', icon: '', category: ECategory.WOODCRAFTING },
    [EItem.CEDAR_NEEDLES]: { itemName: 'Кедровые иголки', icon: '', category: ECategory.WOODCRAFTING },
    [EItem.HIGH_QUALITY_WOOD]: { itemName: 'Качественная древесина', icon: '', category: ECategory.WOODCRAFTING },
    [EItem.SPRUCE_NEEDLES]: { itemName: 'Еловые иголки', icon: '', category: ECategory.WOODCRAFTING },
    [EItem.GLOWING_BERRY]: { itemName: 'Светящаяся ягода', icon: '', category: ECategory.WOODCRAFTING },
    [EItem.VALUABLE_WOOD]: { itemName: 'Ценная древесина', icon: '', category: ECategory.WOODCRAFTING },
    [EItem.MAPLE_LEAFS]: { itemName: 'Кленовый лист', icon: '', category: ECategory.WOODCRAFTING },
    [EItem.PITCH]: { itemName: 'Смола', icon: '', category: ECategory.WOODCRAFTING },
    [EItem.FIRST_CLASS_WOOD]: { itemName: 'Первосортная древесина', icon: '', category: ECategory.WOODCRAFTING },
    [EItem.STICKMAN]: { itemName: 'Палочник', icon: '', category: ECategory.WOODCRAFTING }
